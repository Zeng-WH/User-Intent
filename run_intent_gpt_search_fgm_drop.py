...
from model.modeling_gpt2 import GPT2ForSequenceClassificationDrop
...
def main():
    ...
    config.drop_out = model_args.drop_out
    config.multi_drop = model_args.multi_drop
    ...
    model = GPT2ForSequenceClassificationDrop.from_pretrained(
